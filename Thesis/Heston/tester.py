...
sobol3_imp = np.loadtxt("Data/hestonSobolGridImpVol2_compare2_200000.csv", delimiter=",")

sobol3_filter = np.all(sobol3_imp != 0, axis = 1)
sobol3_output = sobol3_imp[sobol3_filter, :]